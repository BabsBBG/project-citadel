...
4. **Detection pipeline worked.** VM journal confirmed the attack. Log Analytics confirmed the IP. Sentinel's detection rule was positioned to fire on future events. The full SOC workflow - detect, investigate, contain. It was completed in under 10 minutes.
